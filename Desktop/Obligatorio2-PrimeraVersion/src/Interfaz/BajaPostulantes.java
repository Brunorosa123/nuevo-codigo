...
public class BajaPostulantes extends javax.swing.JFrame implements PropertyChangeListener{
    ...
    public BajaPostulantes(Sistema s) {
        ...
        for(int i=0; i< miModelo.getListaPostulantes().size(); i++){
        modelojlist.addElement(miModelo.getListaPostulantes().get(i).get);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaPostulantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaPostulantes().setVisible(true);
            }
        });
    }
