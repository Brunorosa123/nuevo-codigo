...
public class ConsultaParaPuesto extends javax.swing.JFrame {
    ...
    private ArrayList<Postulante> postulantesAprobados;
    ...
    private void exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportarActionPerformed
        ...
        for (Postulante postulante : postulantesAprobados) {
            archivo.grabarLinea(postulante.getNombre());
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        if (puesto != null) {
            ...
            postulantesAprobados = miModelo.obtenerPostulantesConTematicasYNivel(tematicasPuesto, nivel);
            ...
            Collections.sort(postulantesAprobados);
