...
public class Entrevista implements Serializable, Comparable<Entrevista>{
    ...
    @Override
    public int compareTo(Entrevista otraEntrevista) {
        return Integer.compare(otraEntrevista.getPuntaje(), this.getPuntaje());
    }
